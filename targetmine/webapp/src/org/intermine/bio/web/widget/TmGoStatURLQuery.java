...
public class TmGoStatURLQuery implements WidgetURLQuery {
	...
	public PathQuery generatePathQuery(boolean showAll) {
		...
		q.addViews(prefix + ".ncbiGeneNumber", prefix + ".symbol", prefix + ".organism.shortName",
				prefix + ".goAnnotation.ontologyTerm.parents.identifier", prefix
		...
		if (!showAll) {
			...
			q.addConstraint(Constraints.oneOfValues(prefix
					+ ".goAnnotation.ontologyTerm.parents.identifier", Arrays.asList(keys)));
		}

		q.addOrderBy(prefix + ".goAnnotation.ontologyTerm.parents.identifier", OrderDirection.ASC);
