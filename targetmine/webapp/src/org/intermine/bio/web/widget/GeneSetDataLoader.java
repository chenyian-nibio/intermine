...
public class GeneSetDataLoader extends EnrichmentWidgetLdr {
	...
	public Query getQuery(String action, List<String> keys) {
		...
		QueryObjectReference qor2 = new QueryObjectReference(qcGeneSetCluster, "dataSet");
		...
		cs.addConstraint(new SimpleConstraint(qe2, ConstraintOp.EQUALS, new QueryValue(dataSet
				.toLowerCase())));
