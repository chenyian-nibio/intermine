...
public class GeneDrugDataLoader extends EnrichmentWidgetLdr {
	...
	public GeneDrugDataLoader(InterMineBag bag, ObjectStore os, String extraAttribute) {
		this.bag = bag;
	...
	public Query getQuery(String action, List<String> keys) {
		...
		// constrain on protein
		QueryCollectionReference c10 = new QueryCollectionReference(qcGene, "proteins");
		cs.addConstraint(new ContainsConstraint(c10, ConstraintOp.CONTAINS, qcProtein));
