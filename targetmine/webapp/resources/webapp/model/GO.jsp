...
<div id="hiddenDiv1" class="dataSetDescription">
      ...
      <p>
      TargetMine has GO annotations for <i>Human</i>, <i>Rat</i>, <i>Mouse</M>.
      </p>
        <ul>
         <li><i>H. sapien</i> - GO annotations for <i>H. sapien</i> gene products assigned by the <a href="http://www.ebi.ac.uk/GOA/" target="_new">GO annotation@EBI</a> project.</li><br/>
         <li><i>R. norvegicus</i> - GO annotations for <i>R. norvegicus</i> gene products assigned by the <a href="http://www.ebi.ac.uk/GOA/" target="_new">GO annotation@EBI</a> project.</li><br/>
         <li><i>M. musculus</i> - GO annotations for <i>M. musculus</i> gene products assigned by the <a href="http://www.ebi.ac.uk/GOA/" target="_new">GO annotation@EBI</a> project.</li><br/>
       </ul>
      </div>
