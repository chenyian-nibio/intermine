...
/**
 * A simplified UniportEntry class from the uniprot parser 
 * 
 * @author chenyian
 */
public class SimpleUniprotEntry
{
    private static final Logger LOG = Logger.getLogger(SimpleUniprotEntry.class);
     ...
     */
    public SimpleUniprotEntry(String primaryAccession) {
     ...
     */
    public SimpleUniprotEntry createIsoformEntry(String accession) {
    	SimpleUniprotEntry entry = new SimpleUniprotEntry(accession);
